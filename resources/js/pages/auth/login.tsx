...
export default function Login({ status, canResetPassword }: LoginProps) {
    // optional local state to show selected role visually
    ...
    return (
        ...
        >
            ...
            <Form
                ...
                // Pastikan form menerima field 'role' — kita set default melalui input hidden atau controlled input
                data={{ role }} // kalau controller.form() punya initial data, sesuaikan; ini contoh mengirim role
